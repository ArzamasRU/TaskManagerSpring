...
public interface UserEndpoint {
    ...
    public java.util.List<ru.lavrov.tm.endpoint.TaskDTO> getUserTasks(
    ...
    @WebResult(name = "return", targetNamespace = "")
    public java.util.List<ru.lavrov.tm.endpoint.ProjectDTO> getUserProjects(
    ...
    @WebResult(name = "return", targetNamespace = "")
    public ru.lavrov.tm.endpoint.UserDTO getUser(
