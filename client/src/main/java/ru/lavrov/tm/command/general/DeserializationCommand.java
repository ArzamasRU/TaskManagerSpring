...
public final class DeserializationCommand extends AbstractCommand {
    ...
    public void execute() {
        ...
        @Nullable final Collection<Project> projectList = SerializationUtil.read(Constant.PROJECTS_FILE_PATH);
        ...
        @Nullable final Collection<Task> taskList = SerializationUtil.read(Constant.TASKS_FILE_PATH);
        ...
        @Nullable final Collection<User> userList = SerializationUtil.read(Constant.USERS_FILE_PATH);
